        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-4 ">
          {Restaurant_data.map((data, index) => (
            <div key={index} className="flex" data-aos="fade-up">
              <div
                className=" flex flex-col border-2 p-4 rounded-lg shadow-lg cursor-pointer hover:scale-105
                 hover:border-yellow-500 hover:shadow-2xl transform transition-transform duration-500"
                onClick={() =>
